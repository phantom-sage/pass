        ...
        @if(count($volunteers) > 0)
            <div class="flex flex-wrap">
                @if(session('volunteer_request_message'))
                    <div x-data="{ open: true }" x-show="open" class="mx-5 w-full my-5 shadow-lg bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
