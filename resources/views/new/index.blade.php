...
@section('page_header')
    <header class="bg-white shadow">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h2 @if(app()->getLocale() === 'ar') style="direction: rtl;" @endif class="font-black text-xl text-gray-800 leading-tight @if(app()->getLocale() === 'ar') float-right cairo-font @endif">
                {{ __('newspage.header') }}
            </h2>
                    ...
                    <div class="w-full sm:w-full md:w-6/12 lg:w-4/12 xl:w-4/12">
                        <div class="max-w-sm rounded overflow-hidden shadow-lg block mx-auto my-3 hover:shadow-xl transition ease-out duration-500 sm:m-3 md:m-3 lg:m-3">
                            ...
                            <div class="px-6 py-4">
                                ...
                                @if(app()->getLocale() === 'ar') <div class="clearfix"></div> @endif
                                <p style="direction: @if(app()->getLocale() === 'ar') rtl; @endif" class="text-gray-700 text-base @if(app()->getLocale() === 'ar') float-right @endif">
                                    {{ $new->description }}
                                </p>
                                @if(app()->getLocale() === 'ar') <div class="clearfix"></div> @endif
                            </div>
                            ...
                            <div class="px-6 pt-4 pb-2 mx-auto text-center mb-2">
                                <a class="@if(app()->getLocale() === 'ar') cairo-font @endif bg-blue-600 text-white px-4 py-2 border rounded shadow-sm" href="{{ route('news.show', ['locale' => app()->getLocale(), 'news' => $new]) }}">
                                    {{ __('newspage.seemore') }}
                                </a>
                            </div>
                        </div>
